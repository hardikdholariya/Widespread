...
$data->select($following, 'username,profileImg,story,userstroy.openStory', "userstroy ON `{$following}`.following = userstroy.postStoryUsername JOIN user ON user.username = userstroy.postStoryUsername", "userstroy.postStoryUsername='{$user}'");
